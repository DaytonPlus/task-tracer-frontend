  ...
  return (
		<nav className="flex items-center justify-between flex-wrap bg-teal-500 p-6">
		  ...
		  <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
		    <div className={`text-sm lg:flex-grow ${showMenu?'':'hidden'} lg:block`}>
		    ...
		    <div>
		      <Link to={user ? "/logout" : "/login"} className="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-teal-500 hover:bg-white mt-4 lg:mt-0">
		         {user ? "Logeout" : "Login"}
		      </Link>
		    </div>
		  </div>
